...
class Locale {
  ...
  * */
  static String get(String s, [String arg]) {
    var res = s;
    if (_stringsMap.containsKey(s)) {
      if (0 <= languageCode && languageCode < _stringsMap[s].length) res = _stringsMap[s][languageCode];
    }
  ...
  static Map<String, List<String>> _stringsMap = {
    ...
    "Sign in with": ["Войти в систему с", "으로 로그인", "Kirish yo'lini tanlang"],
    ...
    "Signed in with KakaoTalk.": ["Вы вошли в систему с помощью KakaoTalk.", "카카오 톡으로 로그인했습니다.", "KakaoTalk bilan tizimga kirgansiz."],
    "Failed to login with KakaoTalk.\nPlease try again later!": ["Не удалось войти с помощью KakaoTalk. \nПовторите попытку позже!", "카카오 톡으로 로그인하지 못했습니다. \n 나중에 다시 시도 해주세요!", "KakaoTalk bilan tizimga kirib bo'lmadi. \nIltimos, keyinroq qayta urinib ko'ring!"],
    "Signed in with Facebook.": ["Вы вошли в систему с помощью Facebook.", "Facebook으로 로그인했습니다.", "Facebook bilan tizimga kirildi."],
    "Failed to login with Facebook.\nPlease try again later!": ["Не удалось войти через Facebook. \nПовторите попытку позже!", "Facebook으로 로그인하지 못했습니다. \n 나중에 다시 시도하십시오!", "Facebook bilan kirishda xatolik yuz berdi. \nIltimos, keyinroq qayta urinib ko'ring!"],
    ...
    "Decline": ["Oтказать","쇠퇴","Ruxsat bermaslik"],
