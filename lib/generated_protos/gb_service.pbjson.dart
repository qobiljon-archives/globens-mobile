...
final $typed_data.Uint8List fetchProductDetailsDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List fetchJobDetailsDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List createJobApplicationDescriptor = $convert.base64Decode('ChRDcmVhdGVKb2JBcHBsaWNhdGlvbhpZCgdSZXF1ZXN0Eh4KCnNlc3Npb25LZXkYASABKAlSCnNlc3Npb25LZXkSFAoFam9iSWQYAiABKAVSBWpvYklkEhgKB21lc3NhZ2UYAyABKAlSB21lc3NhZ2UaJAoIUmVzcG9uc2USGAoHc3VjY2VzcxgBIAEoCFIHc3VjY2Vzcw==');
...
final $typed_data.Uint8List fetchJobApplicationDetailsDescriptor = $convert.base64Decode('');
...
const SubmitEmployeeReview_Request$json = const {
  ...
  '2': const [
    const {'1': 'sessionKey', '3': 1, '4': 1, '5': 9, '10': 'sessionKey'},
    const {'1': 'businessPageId', '3': 2, '4': 1, '5': 5, '10': 'businessPageId'},
    const {'1': 'employeeUserId', '3': 3, '4': 1, '5': 5, '10': 'employeeUserId'},
    const {'1': 'text', '3': 4, '4': 1, '5': 9, '10': 'text'},
    const {'1': 'timestamp', '3': 5, '4': 1, '5': 3, '10': 'timestamp'},
  ],
};
...
final $typed_data.Uint8List submitEmployeeReviewDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List retrieveEmployeeReviewsDescriptor = $convert.base64Decode('');
